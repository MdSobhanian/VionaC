...
//mail("postmaster@snetworks.biz", "IPN: $site_name", $fullipn);
...
else
{
	...
	if (strcmp ($ret, "VERIFIED") == 0)
	{
		...
		if ((0.00+$payment_amount) < $total_price)    // Version 5.0
		{
...
EOB;
		...
		$msg .= Array2Str(": ", "\n", $fullipnA);
		/* Start Version 5.1 - Send mail using SMTP */
...
function FailInsert($s)
{
	...
	// TODO: Send mail abt this and die
	$msg = <<< EOB
