...
<tr>
<td><!-- <h2><img src="images/category.gif" border="0" align="absmiddle"> <?php echo $page_head; ?></h2> --></td>	<!-- Version 5.0 -->
<td align="right" valign="top">
&nbsp;
<?php if ($rssurl && !$xsearchmode) { ?>
...
?>
 <div id="superRegionNavMenu" style="margin-top:1em; font-size:12px;">
