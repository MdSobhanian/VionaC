...
header("Content-Type: text/xml; charset={$langx['charset']}");		// Version 5.0

/* Begin Version 5.0 */

// RSS Channel URL

/* Begin Version 5.7 - Feed recommendations */
...
/* End Version 5.7 - Feed recommendations */
...
if (mysql_num_rows($res)) {
	...
	$lastBuildDate = mktime(0, 0, 0, 1, 1, 2009);	// Version 5.0
}
...
echo '<'.'?xml version="1.0" encoding="'.$langx['charset'].'"?'.'>';	// Version 5.0
?>
...
?>
		<item>
			...
			<link><?php echo "$script_url/$url"; ?></link>
            			<!-- Begin Version 5.3 - Feed recommendations -->
			<guid><?php echo "$script_url/$url"; ?></guid>
			<!-- End Version 5.3 - Feed recommendations -->
			<description><![CDATA[<?php 
			$row['addesc'] = strip_tags($row['addesc']);
