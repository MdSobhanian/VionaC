...
+===================================================+
| File: admin/logo.php                            |
| Import categories, locations and ads              |
+---------------------------------------------------+
...
if(isset($_POST['submit']))
{
	...
	if ($image && !$demo)
	{
		...
		{
			//print error message
			$unknown_ext = "File format is not supported. Please try again uploading file ending with \".gif\".";
			$errors=1;
		}
		else
		{
...
<table>
  <tr>
    ...
    <td valign="top" class="tip"> Browse for your logo file in your computer by pressing the browse buton. Once selected then press Update button to upload it. <br /> <strong>THIS IS NO LONGER VALID DUE TO HIGHLY MODIFICATION FOR BACKPAGE</strong></td>
  </tr>
</table>
...
Please note:<br>
* Logo must be in GIF format file.<br>
...
<tr>
  ...
  <td><table width="520" border="0" cellspacing="0" cellpadding="0" class="box">
    ...
    <tr>
      <td><img src="../images/logo.gif" alt="" name="logo" border="1" id="logo"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
