...
<form class="box" action="" method="get" style="width: 200px;">	<!-- Version 5.0 -->
...
<div class="legend" align="right"><b>V</b> - Email Verified &nbsp; <b>A</b> - Approved &nbsp; <b>P</b> - Paid</div>    <!-- Version 5.0 -->
...
<table width="100%" cellpadding="6" cellspacing="1" class="grid">
	<tr>
		...
		<td class="gridhead" width="18%">Email / IP</td>
...
?>
		...
		<div class="adpreview">
		<?php echo substr($row['addesc'], 0, $admin_adpreview_chars); ?>
		<?php if(strlen($row['addesc'])>$admin_adpreview_chars) echo "..."; ?>
		</div>
		<?php } ?>
...
<tr>
<!-- START mod-paid-categories -->
<td colspan="12" align="right">With selected: 
<!-- END mod-paid-categories -->
