...
$your_message
<br><br>
To unsubscribe from this newsletter, click on the following link to visit your ad's edit page:<br>
<a href=\"#\">(the user's edit link will appear here)</a><br><br>
    ...
    <tr>
      <td><table cellpadding="4" cellspacing="0" border="0" width="100%">
          ...
          <tr>
			...
			<td align="right">You currently have <b><?php echo $total_subscribers; ?></b> total subscribers <i>(excl. admin)</i></td>
		  </tr>
		    <td colspan="2">	
