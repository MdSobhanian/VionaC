...
$today_zero_hours = mktime(0, 0, 0, $m, $d, $y);
?>
<?php printStat("SELECT COUNT(*) FROM $t_users WHERE joined >= $today_zero_hours"); ?>
</div>
...
<div class="stat-title">signups<br>this week</div>
</a>
</div>
...
<td class="alt-column urgent-stat-column">
<div class="stat urgent-stat">
<a href="accounts.php?search_user=&sort=active">
<div class="stat-num">
